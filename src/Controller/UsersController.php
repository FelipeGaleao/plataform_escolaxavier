...
class UsersController extends AppController
{
    ...
    public function login()
    {
        if ($this->request->is('post')) {
            ...
            $this->Flash->error(__('Usuário não encontrado ou senha invalida, tente novamente.'));
        }
    }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Users->delete($user)) {
            ...
            $this->Flash->error(__('Não foi possível deletar esse usuário, tente novamente.'));
        }
