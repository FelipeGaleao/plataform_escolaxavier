                            ...
                            <div class="col-12">
                                ...
                                <div class="col-md-6 col-xl-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Insira o nome do curso" value="<?php echo $course->name;?>">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-12">
                                    <div class="mb-3">
                                        <label class="form-label">Descrição</label>
                                        <textarea type="text" class="form-control" name="description" id="description" placeholder="Insira a descrição do curso"><?php echo $course->description;?></textarea>
                                    </div>
                                    <div class="col-md-6 col-xl-12">
                                        <div class="mb-3">
