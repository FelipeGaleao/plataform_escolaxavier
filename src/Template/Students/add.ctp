<?php $this->assign('title', 'Cadastrando um novo estudante'); ?>
<div class="row">
    <div class="col-12">
        <div class="card">
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12">
                                <div class="col">
                                    <label>Nome</label>
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Insira o nome do estudante">
                                </div>
                                <div class="col">
                                    <label>Email</label>
                                    <input type="text" class="form-control" name="email" id="email" placeholder="Insira o email do estudante">
                                </div>
                                <div class="col">
                                    <label>CPF</label>
                                    <input type="text" class="form-control" name="cpf" id="cpf" placeholder="Insira o CPF do estudante">
                                </div>
