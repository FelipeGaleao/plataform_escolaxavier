...
class ReportsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'average_final' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'course_id' => 1,
                'subject_id' => 1,
                'average_final' => 'Lorem ipsum dolor sit amet',
                'status' => 'Lorem ipsum dolor sit amet',
                'created' => '2020-07-10 19:53:41',
                'modified' => '2020-07-10 19:53:41',
                'student_id' => 1
            ],
        ];
        parent::init();
